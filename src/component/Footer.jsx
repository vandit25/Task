...
function Footer() {
  return (
    <div className='w-[100%] h-[438.53px] mt-[42.37px]'>
      <div className='w-[100%] h-[209.31px] flex flex-col justify-around items-center bg-[#F5F7FA]'>
      ...
      <div className='w-[100%] h-[229.21px] bg-[#263238] flex justify-around items-center'>
        <div className='w-[243.62px] h-[131.58px] flex flex-col justify-between'>
            <img className='w-[132.95px] h-[20.65px]' src={logo}/>
